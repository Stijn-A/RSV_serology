...
header = ['age_days',  \
       ...
       'IgG_Ga', 'IgA_Ga', 'IgG_Gb', 'IgA_Gb', 'IgG_N', 'IgA_N' \
        'n_household', 'household04','household59'\
            ,'visitnursery_child',\
        'visitnursery_house','contacttotal', 'contact04', \
            'contact59', 'sex']
df_IgG.to_csv('/home/andewegs/RSV_serology/data/participants_under5.csv'\
...
header = ['age_days', 'infection',\
       ...
       'IgG_Ga', 'IgA_Ga', 'IgG_Gb', 'IgA_Gb', 'IgG_N', 'IgA_N' \
        ...
        'visitnursery_house', 'contacttotal', 'contact04', \
            'contact59', 'sex']
df_infection.to_csv('/home/andewegs/RSV_serology/data/infection_status.csv'\
                    , columns=header,index=False)
